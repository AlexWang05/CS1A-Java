...
public class ProductTester {
	...
	public static void main(String[] args) {
		...
		/*
		 * ------------SAMPLE RUN-------------- itemNumber : 0 Name : null Quantity in
		 * stock : 0 Price : 0.0
		 * 
		 * itemNumber : 0 Name : null Quantity in stock : 0 Price : 0.0
		 * 
		 * itemNumber : 3 Name : Marker Quantity in stock : 200 Price : 7.75
		 * 
		 * itemNumber : 4 Name : Colored Pencil Quantity in stock : 500 Price : 9.5
		 * 
		 * itemNumber : 5 Name : Eraser Quantity in stock : 150 Price : 4.0
		 * 
		 * itemNumber : 6 Name : Notebook Quantity in stock : 400 Price : 6.75
		 * 
		 */
	}
